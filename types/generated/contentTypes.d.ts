...
export interface ApiProdutoProduto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    imagem: Attribute.Media<'images', true> & Attribute.Required;
    ...
    categoria: Attribute.Relation<
      ...
      'api::categoria.categoria'
    >;
    quantidade: Attribute.Integer & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiUsuarioUsuario extends Schema.CollectionType {
  ...
  attributes: {
    ...
    carrinho: Attribute.Relation<
      ...
      'api::carrinho.carrinho'
    >;
    nascimento: Attribute.Date & Attribute.Required;
